...
if [ ! -z "$CLASSPATH" ]; then
  ...
  export CLASSPATH=${CPADD}:${DAIKONDIR}/java/dcomp_premain.jar:${DAIKONDIR}/java/dcomp_rt.jar:${JAVA_HOME}/jre/lib/rt.jar:${JAVA_HOME}/lib/tools.jar:/cygdrive/c/Users/yxy/Documents/muScript/muJavaX.jar:/cygdrive/c/Users/yxy/Documents/muScript/openjava.jar:/cygdrive/c/Users/yxy/Documents/muScript/commons-io-2.4.jar:/cygdrive/c/Users/yxy/Documents/muScript/hamcrest-core-1.3.jar:/cygdrive/c/Users/yxy/Documents/muScript/junit.jar
  # For Cygwin we need to convert CLASSPATH to windows format
  if [ "$OSTYPE" == "cygwin" ]; then
    export CLASSPATH="`/cygdrive/c/cygwin64/bin/cygpath -wp $CLASSPATH`"
  fi
fi
